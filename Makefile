...
UNREALROOTPATH = /home/zeronul/installs/UnrealEngine
GAMEPROJECTFILE =/home/zeronul/projects/unreal/CryptRaider/CryptRaider.uproject
...
TARGETS = \
	...
	UnrealServer \
	CryptRaider-Linux-Debug  \
	CryptRaider-Linux-DebugGame  \
	CryptRaider-Linux-Test  \
	CryptRaider-Linux-Shipping  \
	CryptRaider \
	CryptRaiderEditor-Linux-Debug  \
	CryptRaiderEditor-Linux-DebugGame  \
	CryptRaiderEditor-Linux-Test  \
...
CryptRaider-Linux-Debug:
	 $(PROJECTBUILD) CryptRaider Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CryptRaider-Linux-DebugGame:
	 $(PROJECTBUILD) CryptRaider Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CryptRaider-Linux-Test:
	 $(PROJECTBUILD) CryptRaider Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
CryptRaiderEditor-Linux-Debug:
	 $(PROJECTBUILD) CryptRaiderEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CryptRaiderEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CryptRaiderEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CryptRaiderEditor-Linux-Test:
	 $(PROJECTBUILD) CryptRaiderEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
